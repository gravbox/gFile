...
namespace Gravitybox.gFileSystem.EFDAL
{
	...
	internal static partial class DBHelper
	{
		...
		{
			return GetConnection(Gravitybox.gFileSystem.EFDAL.gFileSystemEntities.GetConnectionString());
		}
	...
	/// </summary>
	public partial interface IBusinessObject : Gravitybox.gFileSystem.EFDAL.IReadOnlyBusinessObject
	{
		/// <summary>
...
namespace Gravitybox.gFileSystem.EFDAL.EventArguments
{
...
namespace Gravitybox.gFileSystem.EFDAL.Exceptions
{
